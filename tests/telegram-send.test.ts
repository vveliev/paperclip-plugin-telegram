...
describe("answerCallbackQuery", () => {
  // The ok:true and ok:false branches already have direct coverage upstream
  // (see tests/telegram-api.test.ts). This adds the one case that suite
  // doesn't: the network throwing outright, not just Telegram replying ok:false.
