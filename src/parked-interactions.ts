 ...
 * and reacting to a later button press (GIF-158).
 *
 ...
 * runs, per BLA-606); `sweepExpired()` walks a per-flow index of live keys so
 ...
 * `checkTimeouts` and the sweeper, for why: BLA-218/GIF-153).
 */
 ...
 * run against a controlled clock instead of real time (BLA-218/GIF-153).
 */
