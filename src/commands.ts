...
const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    needsBoardToken: false,
    handler: (cc) => handleConnect(cc.ctx, cc.token, cc.chatId, cc.args, cc.messageThreadId, cc.connectCompanyIds),
  },
  {
...
async function handleDecisions(
  ...
  const link = await companyForChat(ctx, chatId, resolvedCompanyId);
  if (!link.linked) {
